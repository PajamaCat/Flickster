...
* [x] Utilized Jackson JSON Library for parsing JSON response
...
- [ButterKnife](http://jakewharton.github.io/butterknife/) - a popular View "injection" library for Android
- [Jackson](https://github.com/FasterXML/jackson) - a JSON library for Java
